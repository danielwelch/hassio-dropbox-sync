...
```json
{"addon":"3729eaa2_dropbox_sync","input":{"command":"upload"}}
```
...
*Note*: The hash `3729eaa2` that is prepended to the `dropbox_sync` add-on slug above is required. [See below](#repository-slugs-in-hassio) for an explanation. 
### Configuration
